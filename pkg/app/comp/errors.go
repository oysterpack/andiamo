...
var (
	UniqueOptionTypeConstraintErrClass = err.NewDesc("01DCW50DM81QZH5E0G101DKY98", "UniqueOptionTypeConstraintErr", "option types must be unique")
...
var (
	OptionsRequiredErrClass = err.NewDesc("01DCVNVW0QMJH345SWQR8Q81N7", "OptionsRequiredErr", "at least 1 option is required")
	OptionsRequiredErr      = err.New(OptionsRequiredErrClass, "01DCVNVXSTEBWPM1BBQFM0ZKXJ")

	OptionsNotMatchingDescErrClass = err.NewDesc("01DCW3NEMQ7ESTR7D9184Y4DBC", "OptionsNotMatchingDescErr", "options not matching descriptor")
